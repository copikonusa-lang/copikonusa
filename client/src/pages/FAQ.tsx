...
const faqs = [
  ...
  { q: "¿Qué métodos de pago aceptan?", a: "Aceptamos Zelle (USD), Binance USDT, y transferencia/pago móvil en bolívares." },
  ...
  { q: "¿Puedo pedir varios productos?", a: "Sí, puedes agregar hasta 3 unidades de cada producto. Los pedidos con múltiples productos se envían juntos." },
  ...
  { q: "¿Qué productos NO pueden enviar?", a: "No enviamos armas, drones, químicos peligrosos, medicamentos con receta, baterías de litio grandes, ni productos restringidos por aduanas." },
